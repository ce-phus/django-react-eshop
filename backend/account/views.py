...
class UserRegisterView(APIView):
    ...
    def post(self, request, format=None):
        ...
        # Create the user with hashed password and let Django set the last_login dynamically
        ...
        user.last_login = timezone.now()  # Set the last_login to the current timestamp
        user.save(update_fields=['last_login'])  # Save the user with the updated last_login

        # Serialize user data along with token
