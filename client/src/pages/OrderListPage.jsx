...
import { changeDeliveryStatus } from '../actions/laptopActions'
    ...
    <SectionWrapper>
      <div className="">
            ...
            {orders.length > 0 ? (
                ...
                <div class="bg-orange-100 border-l-4 border-orange-500 text-orange-700 p-4 flex flex-col items-center justify-center h-screen" role="alert">
